# Generated by Powerlevel10k configuration wizard on 2025-09-04 at 16:37 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    vcs
    #prompt_vcs_with_conditional_symbol
    newline                 # \n
  ...
  function prompt_vcs_with_conditional_symbol() {
    p10k segment vcs
    if [[ -z $POWERLEVEL9K_VCS_CONTENT_EXPANSION ]]; then
      # Not in a Git repo, so apply the last segment symbol
      p10k segment last_segment_end
    fi
  }
...
#   typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='%1F?'
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_EXPANSION='%F{255}\uF1D3 '
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND="%7f"
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=2
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND="%7f"

  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=3
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND="%7f"
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND="%7f"
  ...
  typeset -g POWERLEVEL9K_IP_FOREGROUND="%7f"
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
  typeset -g POWERLEVEL9K_WIFI_FOREGROUND="%7f"
